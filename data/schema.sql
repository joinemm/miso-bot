...
CREATE TABLE IF NOT EXISTS "fishy"(
  "user_id"	INTEGER,
  "timestamp"	FLOAT,
  "fishy"	INTEGER NOT NULL DEFAULT 0,
  "fishy_gifted"	INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS "guilds"(
  ...
  "starboard_toggle"	INTEGER NOT NULL DEFAULT 1,
  ...
  "rolepicker_enabled"	INTEGER DEFAULT 0,
